...
namespace EmoteScript
{
    public class Emote_Line : Line
    {
        ...
        public static Dictionary<EmoteType, List<EmoteField>> DefaultFields = new Dictionary<EmoteType, List<EmoteField>>()
        {
            ...
            { EmoteType.AwardLevelProportionalSkillXP, new List<EmoteField>() { EmoteField.SkillStat, EmoteField.Percent, EmoteField.Range } },
            { EmoteType.AwardLevelProportionalXP, new List<EmoteField>() { EmoteField.Percent, EmoteField.Range, EmoteField.Display } },
            ...
            { EmoteType.DecrementMyQuest, new List<EmoteField>() { EmoteField.Message } },
            { EmoteType.DecrementQuest, new List<EmoteField>() { EmoteField.Message } },
            ...
            { EmoteType.IncrementMyQuest, new List<EmoteField>() { EmoteField.Message } },
            { EmoteType.IncrementQuest, new List<EmoteField>() { EmoteField.Message } },
